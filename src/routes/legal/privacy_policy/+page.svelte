<script lang="ts">
	...
	const breadcrumbs = ['Home', 'Legal', 'Privacy Policy'];
</script>
...
<div class="text-justify">
	...
	<p class="mt-2 text-gray-700">
		At [Your Company], accessible from [Your Website], one of our main priorities is the privacy of
		our visitors. This Privacy Policy document contains types of information that is collected and
		recorded by [Your Company] and how we use it.
	</p>
	...
	<h2 class="mt-6 text-xl font-semibold text-gray-900">Log Files</h2>
	<p class="mt-2 text-gray-700">
		[Your Company] follows a standard procedure of using log files. These files log visitors when
	...
	<h2 class="mt-6 text-xl font-semibold text-gray-900">Cookies and Web Beacons</h2>
	<p class="mt-2 text-gray-700">
		Like any other website, [Your Company] uses 'cookies'. These cookies are used to store
	...
	<h2 class="mt-6 text-xl font-semibold text-gray-900">GDPR Data Protection Rights</h2>
	<div class="mt-2 text-gray-700">
	...
	<h2 class="mt-6 text-xl font-semibold text-gray-900">Children's Information</h2>
	<p class="mt-2 text-gray-700">
