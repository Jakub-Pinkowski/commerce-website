<script lang="ts">
	...
	import SkeletonRecommendationsCarousel from './SkeletonRecommendationsCarousel.svelte';
	...
	onMount(() => {
		console.log('loading before swiper', loading);
		...
		console.log('loading after swiper', loading);
	});
</script>
								...
								<div class="group inset-0">
									<div class="relative h-full w-full">
										{#if product.price < product.listPrice}
											<div class="badge badge-lg absolute left-2 top-2 z-10 text-main-red">
												Sale
											</div>
